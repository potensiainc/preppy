...
const REVIEW_EVIDENCE: EvidenceArtifactRecord[] = [
  ...
  evidence({
    ...
    sourceUrl: "https://www.dsseoul.org/wp-content/uploads/2025/03/Gebuehrenuebersicht-Tuition-Fees-2025-2026.pdf",
    finalUrl: "https://www.dsseoul.org/wp-content/uploads/2025/03/Gebuehrenuebersicht-Tuition-Fees-2025-2026.pdf",
    sourceType: "OFFICIAL_DOCUMENT", authorityLevel: "PRIMARY", status: "NEEDS_REVIEW",
    excerpt: "2025–26학년도 안내에는 통학비 항목이 포함돼 있어요.", academicYearLabel: "2025–26",
    observedValueJson: { academicYearLabel: "2025–26", documentRole: "FEE_SCHEDULE" }, publicNote: null,
    internalNote: "별도 버스 신청서의 학년도와 달라 통학비 사실을 만들지 않아요.",
  }),
  evidence({
    evidenceId: "dssi-transport-registration-year-conflict", institutionRegistryId: "ST01:19", claimType: "FACT", field: "TRANSPORT",
    sourceName: "DSSI 2024–25학년도 스쿨버스 신청서",
    sourceUrl: "https://www.dsseoul.org/wp-content/uploads/2024/09/Anmeldeformular-Schulbus-2024-2025.pdf",
    finalUrl: "https://www.dsseoul.org/wp-content/uploads/2024/09/Anmeldeformular-Schulbus-2024-2025.pdf",
    sourceType: "OFFICIAL_DOCUMENT", authorityLevel: "PRIMARY", status: "NEEDS_REVIEW",
    excerpt: "스쿨버스 신청서에는 2024–25학년도가 표시돼 있어요.", academicYearLabel: "2024–25",
    observedValueJson: { academicYearLabel: "2024–25", documentRole: "BUS_REGISTRATION" }, publicNote: null,
    internalNote: "2025–26학년도 비용 안내와 기준 연도가 달라 통학비 사실을 만들지 않아요.",
  }),
  evidence({
