...
type InternationalSchoolImportSnapshotInput = z.input<
...
const SCHOOL_SEEDS = [
  ...
  [
    ...
    "용산구",
    "서울특별시 용산구 이태원로 285",
    "https://www.yisseoul.org",
    ["YISS"],
  ],
  [
    "ST01:13",
    "한국영등포화교소학교",
    "Yeongdeungpo Korea Chinese Primary School",
    "yeongdeungpo-korea-chinese-primary-school",
    "11",
    "서울특별시",
    "영등포구",
  ...
  [
    ...
    "https://www.dsseoul.org",
    ["DSSI"],
  ],
  [
    "ST01:20",
    "재한몽골학교",
    "International Mongolian School",
    "international-mongolian-school",
    "11",
    "서울특별시",
    "광진구",
    "서울특별시 광진구 광장로 1",
    "https://www.mongolschool.org",
    [],
  ],
  [
    "ST01:32",
  ...
  [
    ...
    "경기도",
    "수원시 팔달구",
    "경기도 수원시 팔달구 효원로85번길 62-7",
    "https://www.scis.sc.kr",
    [],
  ],
  [
    "ST01:56",
    ...
    addressConflict:
      id === "ST01:6"
        ? {
            ...
            values: [
              {
                addressLine: "서울특별시 서초구 남부순환로364길 7-16",
                evidenceId: "kfs-address-isi",
              },
              {
                addressLine: "서울특별시 강남구 역삼로 509",
                evidenceId: "kfs-address-official",
              },
            ],
          }
        : null,
...
const IDENTITY_EVIDENCE = OFFICIAL_ACTIVE_INTERNATIONAL_SCHOOLS.map((school) =>
  evidence({
    ...
    observedValueJson: {
      ...
      canonicalNameKo: school.canonicalNameKo,
      city: school.city,
    },
    publicNote: null,
    internalNote: null,
...
const CURRENT_TUITION_SOURCES = [
  ["ST01:1", "https://kisseoul.or.kr"],
  ["ST01:3", "https://www.kkfs.org"],
  ...
  ["ST01:6", "https://koreaforeign.org"],
  ["ST01:16", "https://www.lfseoul.org"],
  ["ST01:19", "https://www.dsseoul.org"],
  ["ST01:32", "https://www.kis.or.kr"],
  ["ST01:33", "https://www.siskorea.org"],
  ["ST01:34", "https://www.gsis.sc.kr"],
  ["ST01:36", "https://www.icsu.kr/tuitionfees"],
  ["ST01:56", "https://www.dulwich.org"],
...
const TUITION_EVIDENCE = CURRENT_TUITION_SOURCES.map(([id, url]) =>
  evidence({
    ...
    observedValueJson: {
      academicYearLabel: INTERNATIONAL_SCHOOL_TARGET_YEAR,
      currencyHandling: "원화와 외화를 합산하지 않음",
    },
    publicNote: null,
    internalNote:
      id === "ST01:4" || id === "ST01:5"
...
const REVIEW_EVIDENCE: EvidenceArtifactRecord[] = [
  evidence({
    evidenceId: "kfs-address-isi",
    institutionRegistryId: "ST01:6",
    claimType: "IDENTITY",
    field: "IDENTITY",
    sourceName: "ISI 등록 주소",
    sourceUrl:
      "https://www.isi.go.kr/schl/info/SinfoView.do?schoolId=6&schoolType=ST01",
    finalUrl:
      "https://www.isi.go.kr/schl/info/SinfoView.do?schoolId=6&schoolType=ST01",
    sourceType: "OFFICIAL_REGISTRY",
    authorityLevel: "PRIMARY",
    status: "NEEDS_REVIEW",
    excerpt: "ISI 등록부에는 서울특별시 서초구 소재 주소가 기재돼 있어요.",
    academicYearLabel: null,
    observedValueJson: {
      addressLine: "서울특별시 서초구 남부순환로364길 7-16",
    },
    publicNote: null,
    internalNote: "학교 공식 사이트의 현재 주소와 달라 자동 반입하지 않아요.",
  }),
  evidence({
    evidenceId: "kfs-address-official",
    institutionRegistryId: "ST01:6",
    claimType: "IDENTITY",
    field: "IDENTITY",
    sourceName: "Korea Foreign School 공식 위치 안내",
    sourceUrl: "https://koreaforeign.org/directions-to-kfs",
    finalUrl: "https://koreaforeign.org/directions-to-kfs",
    sourceType: "OFFICIAL_SCHOOL_PAGE",
    authorityLevel: "PRIMARY",
    status: "NEEDS_REVIEW",
    excerpt:
      "학교 공식 위치 안내에는 서울특별시 강남구 역삼로 509가 기재돼 있어요.",
    academicYearLabel: null,
    observedValueJson: { addressLine: "서울특별시 강남구 역삼로 509" },
    publicNote: null,
    internalNote: "ISI 주소와 달라 자동 반입하지 않아요.",
  }),
  evidence({
    evidenceId: "apis-tls-warning",
    institutionRegistryId: "ST01:4",
    claimType: "OPERATION",
    field: "OPERATING_INFO",
    sourceName: "APIS 공식 사이트",
    sourceUrl: "https://www.apis.org",
    finalUrl: "https://www.apis.org",
    sourceType: "OFFICIAL_SCHOOL_PAGE",
    authorityLevel: "PRIMARY",
    status: "VERIFIED_WITH_WARNING",
    excerpt: null,
    academicYearLabel: null,
    observedValueJson: { reachableWithWarning: true },
    publicNote: null,
    internalNote: "수집 시 TLS 인증서 경고가 있어 성공 상태로 승격하지 않아요.",
  }),
  evidence({
    evidenceId: "yiss-tuition-not-found",
    institutionRegistryId: "ST01:10",
    claimType: "FACT",
    field: "TUITION",
    sourceName: "YISS 공식 입학 안내",
    sourceUrl: "https://www.yisseoul.org",
    finalUrl: "https://www.yisseoul.org",
    sourceType: "OFFICIAL_SCHOOL_PAGE",
    authorityLevel: "PRIMARY",
    status: "NOT_FOUND_IN_CHECKED_OFFICIAL_SOURCES",
    excerpt: null,
    academicYearLabel: INTERNATIONAL_SCHOOL_TARGET_YEAR,
    observedValueJson: null,
    publicNote: "확인한 학교 공식 안내에서 학비 정보를 찾지 못했어요.",
    internalNote: "미발표로 해석하지 않아요.",
  }),
  evidence({
    evidenceId: "icsp-tuition-date-limited",
    institutionRegistryId: "ST01:57",
    claimType: "FACT",
    field: "TUITION",
    sourceName: "ICSP 공식 학비 안내",
    sourceUrl: "https://www.icsptk.org",
    finalUrl: "https://www.icsptk.org",
    sourceType: "OFFICIAL_SCHOOL_PAGE",
    authorityLevel: "PRIMARY",
    status: "VERIFIED_WITH_DATE_LIMIT",
    excerpt: "확인된 학비 안내의 기준은 2025–26학년도예요.",
  ...
  evidence({
    evidenceId: "suwon-chinese-tuition-access-failed",
    institutionRegistryId: "ST01:38",
    claimType: "FACT",
    field: "TUITION",
    sourceName: "수원화교중정소학교 공식 사이트",
    sourceUrl: "https://www.scis.sc.kr",
    finalUrl: "https://www.scis.sc.kr",
    sourceType: "OFFICIAL_SCHOOL_PAGE",
    authorityLevel: "PRIMARY",
  ...
  evidence({
    evidenceId: "kis-pangyo-open-house-page",
    institutionRegistryId: "ST01:32",
    claimType: "OPPORTUNITY",
    field: "INFORMATION_SESSION",
    sourceName: "KIS 판교 공식 오픈하우스 안내",
    sourceUrl: "https://www.kis.or.kr/admissions/open-house",
    finalUrl: "https://www.kis.or.kr/admissions/open-house",
    sourceType: "OFFICIAL_ADMISSION_PAGE",
    authorityLevel: "PRIMARY",
    status: "NEEDS_REVIEW",
    excerpt:
      "공식 오픈하우스 페이지에는 9월 29일 오전 10시 시작으로 안내돼 있어요.",
    academicYearLabel: INTERNATIONAL_SCHOOL_TARGET_YEAR,
    observedValueJson: {
      date: "2026-09-29",
      startTime: "10:00",
    ...
    internalNote:
      "학교 캘린더에는 오전 9시 시작으로 표시돼 행사 레코드를 만들지 않아요.",
  }),
  evidence({
    evidenceId: "kis-pangyo-open-house-calendar",
    institutionRegistryId: "ST01:32",
    claimType: "OPPORTUNITY",
    field: "INFORMATION_SESSION",
    sourceName: "KIS 판교 공식 캘린더",
    sourceUrl: "https://www.kis.or.kr/academics/high-school",
    finalUrl: "https://www.kis.or.kr/academics/high-school",
    sourceType: "OFFICIAL_SCHOOL_PAGE",
    authorityLevel: "PRIMARY",
    status: "NEEDS_REVIEW",
    excerpt: "공식 캘린더에는 9월 29일 오전 9시 시작으로 표시돼 있어요.",
    academicYearLabel: INTERNATIONAL_SCHOOL_TARGET_YEAR,
    observedValueJson: {
      date: "2026-09-29",
      startTime: "09:00",
    ...
    publicNote:
      "학교 안내에 적힌 시간이 서로 달라요. 정확한 시간은 학교에 확인해 주세요.",
    internalNote:
      "오픈하우스 페이지의 오전 10시와 달라 행사 레코드를 만들지 않아요.",
  }),
  evidence({
    evidenceId: "icsu-grade-range-conflict",
    institutionRegistryId: "ST01:36",
    claimType: "FACT",
    field: "TARGET_AGE_GRADE",
    sourceName: "ICSU 공식 학교 안내",
    sourceUrl: "https://www.icsu.kr",
    finalUrl: "https://www.icsu.kr",
    sourceType: "OFFICIAL_SCHOOL_PAGE",
    authorityLevel: "PRIMARY",
    status: "NEEDS_REVIEW",
    excerpt: "공식 안내에서 운영 학년이 G4–12와 G5–12로 다르게 표시돼 있어요.",
    academicYearLabel: INTERNATIONAL_SCHOOL_TARGET_YEAR,
    observedValueJson: { conflictingGradeRanges: ["G4–12", "G5–12"] },
    publicNote: null,
    internalNote: "확인 전 운영 학년 사실을 만들지 않아요.",
  }),
  evidence({
    evidenceId: "dssi-transport-year-conflict",
    institutionRegistryId: "ST01:19",
    claimType: "FACT",
    field: "TRANSPORT",
    sourceName: "DSSI 2025–26학년도 학비·통학비 안내",
    sourceUrl:
      "https://www.dsseoul.org/wp-content/uploads/2025/03/Gebuehrenuebersicht-Tuition-Fees-2025-2026.pdf",
    finalUrl:
      "https://www.dsseoul.org/wp-content/uploads/2025/03/Gebuehrenuebersicht-Tuition-Fees-2025-2026.pdf",
    sourceType: "OFFICIAL_DOCUMENT",
    authorityLevel: "PRIMARY",
    status: "NEEDS_REVIEW",
    excerpt: "2025–26학년도 안내에는 통학비 항목이 포함돼 있어요.",
    academicYearLabel: "2025–26",
    observedValueJson: {
      academicYearLabel: "2025–26",
      documentRole: "FEE_SCHEDULE",
    },
    publicNote: null,
    internalNote:
      "별도 버스 신청서의 학년도와 달라 통학비 사실을 만들지 않아요.",
  }),
  evidence({
    evidenceId: "dssi-transport-registration-year-conflict",
    institutionRegistryId: "ST01:19",
    claimType: "FACT",
    field: "TRANSPORT",
    sourceName: "DSSI 2024–25학년도 스쿨버스 신청서",
    sourceUrl:
      "https://www.dsseoul.org/wp-content/uploads/2024/09/Anmeldeformular-Schulbus-2024-2025.pdf",
    finalUrl:
      "https://www.dsseoul.org/wp-content/uploads/2024/09/Anmeldeformular-Schulbus-2024-2025.pdf",
    sourceType: "OFFICIAL_DOCUMENT",
    authorityLevel: "PRIMARY",
    status: "NEEDS_REVIEW",
    excerpt: "스쿨버스 신청서에는 2024–25학년도가 표시돼 있어요.",
    academicYearLabel: "2024–25",
    observedValueJson: {
      academicYearLabel: "2024–25",
      documentRole: "BUS_REGISTRATION",
    },
    publicNote: null,
    internalNote:
      "2025–26학년도 비용 안내와 기준 연도가 달라 통학비 사실을 만들지 않아요.",
  }),
  evidence({
    evidenceId: "sfs-application-2026-27",
    institutionRegistryId: "ST01:5",
    claimType: "OPPORTUNITY",
    field: "ADMISSION_PROCESS",
    sourceName: "SFS 공식 지원 안내",
    sourceUrl: "https://www.seoulforeign.org/admissions/apply",
    finalUrl: "https://www.seoulforeign.org/admissions/apply",
    sourceType: "OFFICIAL_ADMISSION_PAGE",
    authorityLevel: "PRIMARY",
    status: "VERIFIED",
    excerpt:
      "학교는 2026–27학년도 지원서를 접수 중이며 좌석 여부를 먼저 문의하도록 안내해요.",
    academicYearLabel: INTERNATIONAL_SCHOOL_TARGET_YEAR,
    observedValueJson: {
      acceptingApplications: true,
      seatAvailabilityRequired: true,
    },
    publicNote: null,
    internalNote: null,
  }),
...
const SPECIAL_ACCESS_URLS = [
  "https://humphreyscentrales.dodea.edu/",
  "https://humphreyswestes.dodea.edu/",
  "https://humphreysms.dodea.edu/",
  "https://humphreyshs.dodea.edu/",
  "https://osanes.dodea.edu/",
  "https://osanmhhs.dodea.edu/",
  "https://korea-seoul.mid.ru/en/",
] as const;

export const SPECIAL_ACCESS_RECORDS = SPECIAL_ACCESS_SCHOOLS.map(
  (name, index) => ({
...
const CANDIDATE_SEEDS = [
  ...
  [
    "Lighthouse International School Seoul",
    "서울특별시",
    "HOLD",
    "UNKNOWN",
    "lighthouse",
  ...
  [
    "Gangnam International School Jukjeon",
    "경기도",
    "HOLD",
    "UNKNOWN",
    "gis-jukjeon",
  ...
  [
    ...
    "ACADEMY",
    "gen-g",
    "https://www.gengacademy.com",
  ],
  [
    "Gen.G Esports Academy",
    "서울특별시",
    "ACADEMY",
    "ACADEMY",
    "gen-g",
  ...
  [
    ...
    "REGISTERED_ALTERNATIVE",
    "fis",
    "https://www.fayston.org",
  ],
  [
    "Fayston Preparatory School Suji",
    "경기도",
    "REGISTERED_ALTERNATIVE",
    "REGISTERED_ALTERNATIVE",
    "fis",
  ...
  [
    "Fayston Preparatory School Bundang",
    "경기도",
    "HOLD",
    "UNKNOWN",
    "fis",
  ...
  [
    "Seoul International School of Arts",
    "서울특별시",
    "HOLD",
    "UNKNOWN",
    null,
  ...
  [
    "Korea International Christian School Seoul",
    "서울특별시",
    "HOLD",
    "UNKNOWN",
    null,
  ...
  [
    "Korea International Christian School Bucheon",
    "경기도",
    "HOLD",
    "UNKNOWN",
    null,
  ...
  [
    "Korea International Christian School Ilsan",
    "경기도",
    "HOLD",
    "UNKNOWN",
    null,
  ...
  [
    "Global Vision Christian School Seoul",
    "서울특별시",
    "HOLD",
    "UNKNOWN",
    null,
  ...
  [
    "BCC Canadian International School",
    "서울특별시",
    "ACADEMY",
    "ACADEMY",
    null,
  ...
  [
    ...
    "OUT_OF_REGION",
    null,
    "https://www.busanforeignschool.org",
  ],
  [
  ...
  [
    ...
    "OUT_OF_REGION",
    null,
    "https://www.gwangjuforeignschool.org",
  ],
  [
    "Global Vision Christian School Mungyeong",
    "경기도",
    "EXCLUDE_OUT_OF_REGION",
    "OUT_OF_REGION",
    null,
    "https://www.gvcs-es.org",
  ],
] as const satisfies readonly CandidateSeed[];

const SEOUL_ALTERNATIVE_DIRECTORY =
  "https://www.sen.go.kr/user/bbs/BD_selectBbsList.do?q_bbsSn=1524";
const GYEONGGI_ALTERNATIVE_DIRECTORY =
  "https://www.goe.go.kr/goe/na/ntt/selectNttInfo.do?mi=10961&nttSn=2337176";

export const CANDIDATE_SCHOOLS = CANDIDATE_SEEDS.map(
  (
    [name, region, disposition, legalStatus, collisionGroup, officialUrl],
    index,
  ) => ({
    ...
    evidenceUrls: [
      officialUrl ??
        (region === "서울특별시"
          ? SEOUL_ALTERNATIVE_DIRECTORY
          : GYEONGGI_ALTERNATIVE_DIRECTORY),
    ],
    collisionGroup,
    publicationEligibility: "ARTIFACT_ONLY" as const,
    notes: [
      disposition === "EXCLUDE_OUT_OF_REGION"
...
const APIS_TUITION_FACT = {
  ...
  value: {
    ...
    gradeBands: [
      {
        label: "Kindergarten–Grade 5",
        tuitionComponents: [
          {
            currency: "KRW" as const,
            amount: 23_400_000,
            billingUnit: "ANNUAL" as const,
            required: true,
          },
          {
    ...
    extraFees: [
      {
        feeType: "APPLICATION" as const,
        label: "Application processing fee",
        components: [
          {
            currency: "KRW" as const,
            amount: 400_000,
            billingUnit: "ONE_TIME" as const,
            required: true,
          },
        ],
        refundable: false,
      ...
      },
      {
        ...
        label: "Annual bus fee within Seoul",
        components: [
          {
            currency: "KRW" as const,
            amount: 4_000_000,
        ...
        refundable: null,
        note: "서울시 밖 35km 이내는 연 4,100,000원으로 안내돼 있어요.",
      },
    ],
    paymentOptions: [
      "KRW 학비와 버스비는 분기 납부를 선택할 수 있어요.",
      "USD 학비와 그 밖의 비용은 첫 납부 때 전액 납부해요.",
    ],
    refundTerms:
      "USD 학비와 분기 납부액 등 공식 안내에 명시된 비용은 환불되지 않아요.",
    changeNote: "통화별 금액을 임의 환율로 합산하지 않았어요.",
  },
  displayText:
    "2026–27학년도 APIS 학비는 학년군별 원화와 달러 금액으로 나뉘어요.",
  evidenceIds: ["tuition-4"],
...
const SFS_TUITION_FACT = {
  ...
  value: {
    ...
    extraFees: [
      ...
      {
        feeType: "TRANSPORT" as const,
        label: "Annual round-trip bus fee",
        components: [
          {
            currency: "KRW" as const,
            amount: 4_200_000,
  ...
  displayText:
    "2026–27학년도 SFS 학비는 학년군별 원화와 달러 금액으로 나뉘어요.",
  evidenceIds: ["tuition-5"],
  verifiedAt: INTERNATIONAL_SCHOOL_COLLECTED_AT,
};
...
export const INTERNATIONAL_SCHOOL_IMPORT_SNAPSHOT: InternationalSchoolImportSnapshotInput =
  {
    ...
    institutions: OFFICIAL_ACTIVE_INTERNATIONAL_SCHOOLS.map((school) => ({
      ...
      coverages: englishKindergartenSectionValues.map((section) => {
        const override = coverageOverrides.get(
          `${school.registryExternalId}:${section}`,
        );
        return override
          ? {
              section,
              ...override,
              lastCollectedAt: INTERNATIONAL_SCHOOL_COLLECTED_AT,
              lastCheckedAt: INTERNATIONAL_SCHOOL_COLLECTED_AT,
            }
          : {
              section,
      ...
      facts:
        school.registryExternalId === "ST01:4"
          ? [APIS_TUITION_FACT]
          : school.registryExternalId === "ST01:5"
            ? [SFS_TUITION_FACT]
            : [],
      opportunities:
        school.registryExternalId === "ST01:5"
...
function coverageCounts(
  section: (typeof englishKindergartenSectionValues)[number],
) {
  const rows = INTERNATIONAL_SCHOOL_IMPORT_SNAPSHOT.institutions.map(
    (institution) =>
      institution.coverages.find((coverage) => coverage.section === section)!,
  );
  return {
    confirmed: rows.filter((row) => row.status === "CONFIRMED").length,
    needsReview: rows.filter((row) => row.status === "NEEDS_REVIEW").length,
    checkedNotFound: rows.filter((row) => row.status === "CHECKED_NOT_FOUND")
      .length,
...
export const INTERNATIONAL_SCHOOL_PROGRESS = {
  ...
  counts: {
    ...
    importInstitutions:
      INTERNATIONAL_SCHOOL_IMPORT_SNAPSHOT.institutions.length,
  },
  regions: {
    서울특별시: OFFICIAL_ACTIVE_INTERNATIONAL_SCHOOLS.filter(
      (item) => item.city === "서울특별시",
    ).length,
    경기도: OFFICIAL_ACTIVE_INTERNATIONAL_SCHOOLS.filter(
      (item) => item.city === "경기도",
    ).length,
  },
  fieldCoverage: Object.fromEntries(
    englishKindergartenSectionValues.map((section) => [
      section,
      coverageCounts(section),
    ]),
  ) as InternationalSchoolProgress["fieldCoverage"],
  accessSummary: {
    verified: allAccessStatuses.filter((status) => status === "VERIFIED")
      .length,
    warning: allAccessStatuses.filter(
      (status) => status === "VERIFIED_WITH_WARNING",
    ).length,
    dateLimited: allAccessStatuses.filter(
      (status) => status === "VERIFIED_WITH_DATE_LIMIT",
    ).length,
    needsReview: allAccessStatuses.filter((status) => status === "NEEDS_REVIEW")
      .length,
    checkedNotFound: allAccessStatuses.filter(
      (status) => status === "NOT_FOUND_IN_CHECKED_OFFICIAL_SOURCES",
    ).length,
    accessFailed: allAccessStatuses.filter(
      (status) => status === "ACCESS_FAILED",
    ).length,
    leadOnly: allAccessStatuses.filter((status) => status === "LEAD_ONLY")
      .length,
    loginRequired: allAccessStatuses.filter(
      (status) => status === "LOGIN_REQUIRED",
    ).length,
    robotsBlocked: allAccessStatuses.filter(
      (status) => status === "ROBOTS_BLOCKED",
    ).length,
    noPublicResult: allAccessStatuses.filter(
      (status) => status === "NO_PUBLIC_RESULT",
    ).length,
  },
  unresolvedConflicts: [
    {
      code: "kfs-address-conflict",
      institutionRegistryId: "ST01:6",
      note: "ISI 등록 주소와 학교 공식 사이트의 현재 주소가 달라 주소 반입을 보류해요.",
    },
    {
      code: "kis-pangyo-time-conflict",
      institutionRegistryId: "ST01:32",
      note: "오픈하우스 시작 시간이 공식 페이지끼리 달라 행사 생성을 보류해요.",
    },
    {
      code: "icsu-grade-conflict",
      institutionRegistryId: "ST01:36",
      note: "운영 학년 범위가 G4–12와 G5–12로 달라 확인이 필요해요.",
    },
    {
      code: "dssi-transport-year-conflict",
      institutionRegistryId: "ST01:19",
      note: "영문·독문 통학비 안내의 학년도 표기가 달라 사실 생성을 보류해요.",
    },
    {
      code: "suwon-chinese-access-failed",
      institutionRegistryId: "ST01:38",
      note: "공식 사이트 접근 실패로 학비 확인을 마치지 못했어요.",
    },
  ],
